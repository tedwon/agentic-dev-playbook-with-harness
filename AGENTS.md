...
For non-trivial feature work, follow the **[Agentic Development Playbook](agentic-development-playbook_v0.2.md)**. This is a human-in-the-loop workflow with three phases:

1. **Brainstorm** — explore requirements, design decisions, and trade-offs before writing code
2. **Plan** — produce a detailed implementation plan with clear steps and review checkpoints
3. **Execute** — implement the plan step-by-step, with human review at each checkpoint
